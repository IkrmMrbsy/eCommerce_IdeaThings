<!--<a href="/fashion" class="{{ request()->is('/fashion') ? 'bg-lime-900 text-white' : 'text-lime-300 hover:bg-lime-700 hover:text-white' }}">Fashion</a>-->
<div x-data="{ isOpen: false }" class="relative inline-block text-left">
    <div>
      <button type="button" @click="isOpen = !isOpen" class="inline-flex w-full justify-center gap-x-1.5 rounded-md bg-lime-800 px-3 py-2 text-sm font-semibold text-lime-300 shadow-sm ring-1 ring-inset ring-lime-800 hover:bg-lime-700" id="menu-button" aria-expanded="true" aria-haspopup="true">
        Fashion
    ...
    <div 
      ...
      class="absolute left-0 z-10 mt-2 w-56 origin-top-right divide-y divide-lime-100 rounded-md bg-lime-100 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
      
      <div class="py-1" role="none">
        <!-- Active: "bg-gray-100 text-gray-900", Not Active: "text-gray-700" -->
        <a href="/pakaianpria" class="{{ request()->is('/pakaianpria') ? 'bg-lime-900 text-white' : 'text-lime-700 hover:bg-lime-700 hover:text-white' }} block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-0">Pakaian Pria</a>
